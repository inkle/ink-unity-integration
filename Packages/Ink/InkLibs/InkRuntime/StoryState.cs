...
namespace Ink.Runtime
{
    ...
    public class StoryState
    {
        ...
        // This resolves some practical use issues with currentPathString:
        // It doesn't contain the line index/choice index of the path, and only returns the container, ie: "knot.stitch"
        // Returns a valid path when the story cannot continue, ie: at a choice point/story end.
        /// </summary>
